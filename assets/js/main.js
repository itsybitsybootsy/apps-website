...
import { createStage, captions, seg, css, ease, lerp, reduceMotion, toggle } from './engine.js?v=4';
import { mountPhone } from './phone.js?v=4';
...
const load = name => import(`./scenes/${name}.js?v=4`).then(m => m.default).catch(err => { console.warn(`scene ${name}:`, err); return null; });
